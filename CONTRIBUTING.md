...
Thank you for your interest in contributing to AmritaSense! This guide will help you understand how to participate in the project.
...
2. Clone your fork:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/AmritaSense.git
   cd AmritaSense
   ```
...
1. Search the [Issues](https://github.com/AmritaBot/AmritaSense/issues) page to see if a similar bug report already exists
2. If not, create a new issue containing:
   - Detailed bug description
   - Reproduction steps
   - Expected behavior
   - Actual behavior
   - Environment information (OS, Python version, AmritaSense version, etc.)
   - Relevant error messages or screenshots

### Submitting Feature Requests

1. Search the [Issues](https://github.com/AmritaBot/AmritaSense/issues) page to see if a similar feature request already exists
...
python3 -m pytest tests/ --cov=amrita_sense
...
1. Create a new module in `src/amrita_sense/` or extend existing modules
...
Thank you to all community members who have contributed to AmritaSense!
